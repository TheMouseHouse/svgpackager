...
function svgpackager() {
	var args  = processor.parseArguments(process.argv),
		src   = processor.resolveSource(process.argv[2]),
		dest  = processor.resolveDestination(process.argv[3], src),
		pkg   = processor.resolvePackageName(process.argv[4], src),
...
exports.svgpackager = svgpackager;
