...
function Processor() {
    ...
    _this.fileProcessedOutput = function(str){
        var padding = ' ...................................'.white;
        var output  = str.yellow + padding.substring(0, padding.length - str.length);
	...
	if(files.length > 0) {
		...
		for(i in files) {
			...
			svgo.optimize(svgContent, function(optimized) {
                ...
                processor.fileProcessedOutput(file);
